    ...
    <footer className="bg-indigo-900		 text-white pt-12 pb-8 px-4">
      <div className="container overflow-hidden flex flex-col lg:flex-row justify-between mx-auto px-4">
        ...
        <div className="w-3/4 block sm:flex text-sm mt-6 lg:mt-0">
          <ul className="text-stone-50	 list-none p-0 font-bold flex flex-col text-left w-full">
      ...
      <div className="mt-4 pt-6 text-stone-50	 border-t border-gray-800 flex flex-col md:flex-row justify-center items-center">
        <div>© 2022 CALENDLY</div>
