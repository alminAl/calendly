...
const Terms = () => {
    return (
        <div className=' bg-indigo-100'>
            <div className='px-8 md:px-20  pt-14 pb-24'>

                <h2 className='text-center text-3xl lg:text-5xl'><strong>Terms and Conditions</strong></h2>
                <div className='my-10'>
                    <p className='text-xl  lg:text-2xl font-bold mb-3'>Welcome to <span className='text-indigo-600'>Calendry</span>!</p>
                    <p className='text-gray-900'>These terms and conditions lay forth the groundwork for using <span id="M_C2">Calendry</span> website, which may be found at <span id="M_Curl">https://calendly.onrender.com</span></p>
                    <p className='text-gray-900'>We assume that by accessing this website, you agree to these terms and conditions. If you do not agree to all of the terms and conditions listed on this page, do not use <span id="M_C3">Calendry</span>.</p>
                    <p className='text-gray-900'>These Terms and Conditions, Privacy Statement and Disclaimer Notice, and all Agreements are governed by the following terminology: "Client," "You," and "Your" refer to you, the person who logs on to this website and agrees to the Company's terms and conditions. Our Company is referred to as "The Company," "Ourselves," "We," "Ours," and "Us." Both the Client and ourselves are referred to as "Party," "Parties," or "Us."All terms refer to the offer, acceptance, and consideration of payment necessary to begin the process of our assistance to the Client in the most appropriate manner for the express purpose of meeting the Client's needs in respect of the Company's specified services, in line with and subject to, applicable Dutch legislation. Any use of the above language, as well as other words in the singular, plural, capitalization, and/or he/she or they, is assumed to mean the same thing.</p>
                </div>

                <div className='my-10'>
                    <h3 className='text-xl  lg:text-2xl  mb-3 text-indigo-600'><strong>Cookies</strong></h3>
                    <p className='text-gray-900'>Cookies are used on this site. You accepted to use cookies in accordance with the <span id="M_C4">Calendry</span> Privacy Policy by visiting <span id="M_C5">Calendry</span> </p>
                    <p className='text-gray-900'>Cookies are used by most interactive websites to allow us to retrieve the user's information for each visit. Cookies are used on our website to allow specific areas to work and to make things easier for users. Certain of our affiliate/advertising partners may also utilize cookies.</p>
                </div>

                <div className='my-10 text-gray-900'>
                    <h3 className='text-xl  lg:text-2xl  mb-3 text-indigo-600'><strong>License</strong></h3>
                    <p >Unless otherwise stated, all intellectual property rights in all material on <span id="M_C6">Calendry</span> are owned by <span id="M_C7">Calendry</span> and/or its licensors. All rights to intellectual property are reserved. You may use this for your own personal use from <span id="M_C8">Calendry</span>, subject to the restrictions set forth in these terms and conditions.</p>
                    <p >You must not:</p>
                    <ul >
                        <li >Republish material from <span id="M_C9">Calendry</span></li>
                        <li >Sell, rent, or sub-license material from <span id="M_C10">Calendry</span></li>
                        <li>Reproduce, duplicate or copy material from <span id="M_C11">Calendry</span></li>
                        <li>Redistribute content from <span id="M_C12">Calendry</span></li>
                    </ul>
                    ...
                    <p>Parts of this website allow users to post and exchange thoughts and information in designated places. Prior to their appearance on the Internet, <span id="M_C13">Calendry</span> does not filter, edit, publish, or review Comments. The thoughts and opinions expressed in the comments do not reflect those of <span id="M_C14">Calendry</span>, its agents, or affiliates. The views and opinions expressed in comments reflect the views and opinions of the individual who posted them. <span id="M_C15">Calendry</span> shall not be liable for the Comments or for any liabilities, damages, or expenses caused and/or suffered as a result of the use of and/or posting of and/or appearance of the Comments on this website, to the extent permitted by applicable laws.</p>
                    <p><span id="M_C16">Calendry</span> has the right to review all Comments and to remove any Comments that are inappropriate, offensive, or violate our Terms and Conditions.</p>
                    ...
                    <p>You hereby grant <span id="M_C17">Calendry</span> a non-exclusive license to use, reproduce, edit, and authorize others to use, reproduce, edit, and authorize others to use, reproduce, edit, and authorize others to use, reproduce, and edit any of your Comments in any form, format, or media.</p>
                </div>

                <div className='my-10 text-gray-900'>
                    <h3 className='text-xl  lg:text-2xl  mb-3 text-indigo-600'><strong>Hyperlinking to our Content</strong></h3>
                    ...
                    <p>There will be no use of <span id="M_C20">Calendry</span> logo or any artwork for linking without a trademark license agreement.</p>
                </div>

                <div className='my-10 text-gray-900'>
                    <h3 className='text-xl  lg:text-2xl  mb-3 text-indigo-600'><strong>iFrames</strong></h3>
                ...
                <div className='my-10 text-gray-900'>
                    <h3 className='text-xl  lg:text-2xl  mb-3 text-indigo-600'><strong>Content Liability</strong></h3>
                ...
                <div >
                    <h3 className='text-xl  lg:text-2xl  mb-3 text-indigo-600'><strong>Your Privacy</strong></h3>
                    <p>Please read Privacy Policy</p>
                </div>

                <div className='my-10 text-gray-900'>
                    <h3 className='text-xl  lg:text-2xl  mb-3 text-indigo-600'><strong>Reservation of Rights</strong></h3>
                ...
                <div className='my-10 text-gray-900'>
                    <h3 className='text-xl  lg:text-2xl  mb-3 text-indigo-600'><strong>Removal of links from our website</strong></h3>
                ...
                <div className='mt-10 text-gray-900'>
                    <h3 className='text-xl  lg:text-2xl  mb-3 text-indigo-600'><strong>Disclaimer</strong></h3>
