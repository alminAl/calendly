  ...
  return (
    <div className="2xl:mx-auto 2xl:container mx-4">
      <div className="w-full relative flex items-center justify-center">
        <img
          src="https://images.ctfassets.net/k0lk9kiuza3o/2MjJDzicGKnxvX3IvCVe0N/783bc2cc390c64ae31ee78cdae972d00/Calendly_CTA_bg.png"
          alt="calendly"
        ...
        />
        <div className="bg-gray-900 bg-opacity-80 md:my-16 lg:py-16 py-10 w-full md:mx-24 md:px-12 px-4 flex flex-col items-center justify-center relative z-40">
